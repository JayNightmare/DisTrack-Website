    ...
    return (
        <div className="min-h-screen text-white p-8 space-y-6 bg-gradient-to-tl via-zinc-600/20 to-black from-black">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid sm:grid-cols-2 space-y-6 max-w-4xl mx-auto">
                    <div className="max-w-md mx-auto mt-8">
                        <p className="text-zinc-300 mb-4">
                            Have a question or suggestion? Fill out the form
                    ...
                    <div className="grid gap-6 sm:grid-rows-3 px-4 max-w-4xl mx-auto">
                        {contacts.map((c) => (
                            <a
                                key={c.title}
                                href={c.href}
                                className="block p-4 bg-zinc-800/50 rounded hover:bg-zinc-900/50 transition"
                            >
